...
// --- Begin: Vendor Customer Users Addresses Closed Schema --- //
...
}, {collection: config.collCustsUsrsAdrsClsd});

schema.index({delFlag: 1, uDtNum: -1});

module.exports = mongoose.model(config.collCustsUsrsAdrsClsd, schema);
// --- End: Vendor Customer Users Addresses Closed Schema --- //
